    ...
    questions: [
      {
        ...
        answers: ["V-Wars", "Otra Vida", "Stranger Things", "Black Summer"],
        correctIndex: 2,
      },
      {
      ...
      },
      {
        ...
        answers: [
          ...
          "Descubrimiento Plutón",
        ],
        correctIndex: 2,
      },
      {
        question: "¿Cómo llama la gente local a la Ciudad de Nueva York?",
        answers: ["Nueva Amsterdan", "Nueva Orange", "Gotham", "Big Apple"],
        correctIndex: 2,
      },
      {
        question: "¿Cuál es la Cordillera más larga del mundo?",
        answers: ["Los Urales", "Los Apalaches", "Los Andes", "Ártica"],
        correctIndex: 3,
      },
    ],
    passingScore: 3,
...
function checkAnswer(selectedIndex) {
  const currentQuestion =
    level1[currentLevelIndex].questions[currentQuestionIndex];
